...
public class EdWindow extends FreeView<EdModel> {
	...
	private JMenuItem getJMenuItemQuit() {
		if (jMenuItemQuit == null) {
			...
			jMenuItemQuit.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Q, InputEvent.CTRL_DOWN_MASK, false));
	...
	private JMenuItem getJMenuItemFind() {
		if (jMenuItemFind == null) {
			...
			jMenuItemFind.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F, InputEvent.CTRL_DOWN_MASK, false));
